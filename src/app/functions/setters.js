...
export const ifToto = "<div class='perdu'><p class='text-center'>Coucou Loïc :D</p><button class='btn btn-success restart'>Essaie plutôt avec un nombre :P</button><img src='/public/assets/images/nyancat.gif' /></div>";
